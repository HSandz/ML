...
from data1.lab_utils_common import compute_cost
from data1.lab_utils_common import dlblue, dlorange, dldarkred, dlmagenta, dlpurple, dlcolors

plt.style.use('./data1/deeplearning.mplstyle')
n_bin = 5
